...
<style>
    body {
        background-image: url('assets/img/tech/back.jpg') !important;
    ...
    <nav id="sidebar">
        <div class="p-4 pt-5">
            ...
            <ul class="list-unstyled components mb-5">
                ...
                <li>
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Coursework</a>
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        <li>
                            <a href="createCoursework.php">Create Coursework</a>
                        </li>
                        <li>
                            <a href="viewCourseworks.php">View Coursework</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <br/>
                <li>
                    <a href="stu_feeds.php">View Students Feedback</a>
                </li>
            </ul>
        </div>
    </nav>
